...
starter_sadwords = ['שגיא','אני חש תחושת אופוריה','סתום', 'מפגר']
encourage_starter = ['מי זה בכלל' ,'זה יגמר מהר מאוד', 'תיהיה שמח דיכאון']
...
async def on_message(message):
    ...
    if msg.startswith('!היי'):
        await message.channel.send('תחזור לחור שממנו באת')
